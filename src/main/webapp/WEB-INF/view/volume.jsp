...
<div id="container">
    ...
    <div id="vertical-menu">
        ...
        <a href="/volume" class="active">VOLUME</a>
        <a href="/energy">ENERGY</a>
    </div>

    <div id="main_section">
        <div id="unit_text">VOLUME</div>
        ...
        <select onchange="select1fun()" id="select">
            ...
            <option value="1000">MILLILITER</option>
            <option value="0.219969">GALLON</option>
            <option value="2.113376">PINT</option>
            <option value="1.056688">QUART</option>
        </select>
