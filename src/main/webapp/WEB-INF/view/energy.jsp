...
<div id="container">
    ...
    <div id="vertical-menu">
        ...
        <a href="/energy" class="active">ENERGY</a>
    </div>

    <div id="main_section">
        <div id="unit_text">ENERGY</div>
        ...
        <select onchange="select1fun()" id="select">
            <option value="1">JOULE</option>
            <option value="0.001">KILOJOULE</option>
            <option value="0.000001">MEGAJOULE</option>
            <option value="0.238846">CALORIE</option>
            <option value="0.000239">KILOCALORIE</option>
        </select>
